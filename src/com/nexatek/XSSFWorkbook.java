...
public class XSSFWorkbook implements Workbook {
    ...
    @Override
    public Font findFont(boolean bln, short s, short s1, String string, boolean bln1, boolean bln2, short s2, byte b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    @Override
    public int linkExternalWorkbook(String string, Workbook wrkbk) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    @Override
    public void setSheetVisibility(int i, SheetVisibility sv) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    @Override
    public int addOlePackage(byte[] bytes, String string, String string1, String string2) throws IOException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    public void forEach(Consumer<? super Sheet> action) {
        Workbook.super.forEach(action); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }

    @Override
    public Spliterator<Sheet> spliterator() {
        return Workbook.super.spliterator(); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
